# Install in : /root/.ipython/profile_default/ipython_notebook_config.py
...
# c.InlineBackend.rc = {'figure.figsize': (6.0, 4.0), 'savefig.dpi': 72, 'figure.facecolor': (1, 1, 1, 0), 'font.size': 10, 'figure.subplot.bottom': 0.125, 'figure.edgecolor': (1, 1, 1, 0)}
